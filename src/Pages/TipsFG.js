            ...
            <Container>
               ...
               <div className="card">
                   <p>Het is de <span>kennis</span> en <span>inzichten</span> die je hebt op vlak van <span>budgetteren</span>. Denk aan pensioensparen, beleggen, lenen, maar ook het voorkomen van betalings-achterstanden. <span>België</span> staat slechts op de <span>17de</span> plaats staat van de 24 landen als het gaat om financiële geletterdheid.</p>
                    <p>Wat kan je doen:</p>
                    <li>Durf met je <span>ouders</span> over geld praten. </li>
                    <li>Spreek met je ouders een <span>vast bedrag zakgeld</span> af. </li>
                    <li>Laat je <span>voldoende informeren</span> als je gaat beleggen of een lening aangaat. Al eens gedacht aan pensioensparen?</li>
                    <li>Doe <span>online tests</span> om je financiële geletterdheid beter te begrijpen!</li>
                </div>
            </Container>
            <style jsx>{`
            .subTitle {
